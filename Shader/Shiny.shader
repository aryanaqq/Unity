...
Shader "Sprites/ShinyDefault"
{
	Properties
	{
		...
		_ShineColor("ShineColor",Color) = (1,1,1,0)
		_ShineLocation("ShineLocation", Range(-0.5,1.5)) = 0
		_ShineWidth("ShineWidth", Range(0,1)) = 0
	    _ShinePower("ShinePower",Range(1,2))=1
	...
	#include "UnityCG.cginc"
		...
		fixed4 SampleSpriteTexture(float2 uv)
		{
			...
			if (currentDistanceProjection > lowLevel && currentDistanceProjection < highLevel) {
				...
				color.rgb += _ShineColor*_Alpha* whitePower*_ShinePower;
			}
